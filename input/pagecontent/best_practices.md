...
This MDI implementation guide provides opportunities for both identifiers and tracking numbers. Tracking Numbers are for a document and are used for interoperable communication. Identifiers are for individual resources and are assigned from the data source.
