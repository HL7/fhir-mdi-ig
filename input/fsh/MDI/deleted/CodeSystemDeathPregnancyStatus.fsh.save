CodeSystem: CodeSystemDeathPregnancyStatus
Id: CodeSystem-death-pregnancy-status
Title: "CodeSystem - Death Pregnancy Status"
...
The MDI CodeSystem - Death Pregnancy Status artifact overlaps with the VRDR Pregnancy Status Codes artifact."""
* ^status = #active
* ^experimental = false
* ^caseSensitive = true
* ^content = #complete
