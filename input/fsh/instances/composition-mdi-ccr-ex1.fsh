...
// author should be the EDRS ?
* title = "Composition - Cremation Clearance Request - Example"
// 
* section[0]
//  * title = "Death Certificate Review Section"
...
//
* section[+]
//  * title = "Decedent Demographics for review"
...
* section[+]
//  * title = "Death Investigation for review"
...
* section[+]
//  * title = "Death Certification for review"
...
//
* section[+]
//  * title = "Decedent Disposition for review"
